...
const Article = () => {
  ...
  /* 表单筛选功能实现 */
  const onFinish = (values: { channel_id: any; date: any; status: any }) => {
  ...
  // 删除文章
  const delArticle = async (data: { id: any }) => {
  ...
  return (
    <div>
      ...
      >
        <Form onFinish={onFinish} initialValues={{ channel_id: 'lucy', status: 0 }}>
